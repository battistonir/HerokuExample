...
var myFaves = ["tater tots", "cool pillows", "bikes", "plaid shirts"];

var faveList = document.createElement("ul");

for (var i = 0; i < myFaves.length; i++) {
  var fave = myFaves[i];
  // Create the element
  var faveItem = document.createElement("li");
  // give it content
  faveItem.textContent = fave;
  // add it to the page
  faveList.appendChild(faveItem);
}

document.body.appendChild(faveList);
